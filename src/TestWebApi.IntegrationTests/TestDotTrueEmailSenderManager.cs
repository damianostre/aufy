...
public class TestAufyEmailSenderManager : IAufyEmailSenderManager<AufyUser>
{
    ...
    public Task SendEmailConfirmationAsync(AufyUser user, string confirmationLink)
    {
    ...
    public Task SendPasswordResetAsync(AufyUser user, string resetLink)
    {
